...
We will be using the radar chart for comparison between seven variables across two countries. For this assignment, we are only comparing between Singapore and Switzerland in year 2020.
